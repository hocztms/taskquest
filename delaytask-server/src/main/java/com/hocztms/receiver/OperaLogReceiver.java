...
@Slf4j
@Component
public class OperaLogReceiver implements ChannelAwareMessageListener {
    ...
    @Override
    @RabbitListener(queues = "operaLogQueue")
    public void onMessage(Message message, Channel channel) throws Exception {
        ...
        try {
            ...
            operaLogEntity.setCollegeId(operaLogs.getCollegeId());
